...
def write_to_excel(student_name):
    wb=openpyxl.load_workbook('C:/Users/Taiyab/Desktop/AI project/AI/Student Attendance.xlsx')
    #wb=openpyxl.load_workbook('Student Attendance.xlsx')
    sheet=wb.active
    current_date_time=datetime.now().strftime("%Y-%m-%d %H:%M:%S")
    row=[student_name, current_date_time]
    sheet.append(row)
    wb.save('C:/Users/Taiyab/Desktop/AI project/AI/Student Attendance.xlsx')
...
while True:
    ...
    if cv2.waitKey(1) & 0xFF == ord(' '):# the capturing stops when user presses spacebar
        cv2.imwrite('C:/Users/Taiyab/Desktop/AI project/AI/captured_image.jpg', frame) #storing the captured frame as a jpg
        break

cap.release()
cv2.destroyAllWindows()

captured_image = cv2.imread('C:/Users/Taiyab/Desktop/AI project/AI/captured_image.jpg') 
